...
// //         if (!fullName || !streetAddress || !city || !state || !zipCode || !phone || !country) {
...
// //             billingAddress: `${fullName}, ${streetAddress}, ${city}, ${state}, ${zipCode}, ${country}`, // Assuming same as shipping
...
// //                             <input type="text" name="fullName" value={shippingInfo.fullName} onChange={handleChange} placeholder="Full Name" style={styles.input} required />
// //                             <input type="text" name="streetAddress" value={shippingInfo.streetAddress} onChange={handleChange} placeholder="Street Address" style={styles.input} required />
// //                             <input type="text" name="landmark" value={shippingInfo.landmark} onChange={handleChange} placeholder="Landmark (Optional)" style={styles.input} />
// //                             <input type="text" name="city" value={shippingInfo.city} onChange={handleChange} placeholder="City" style={styles.input} required />
// //                             <input type="text" name="state" value={shippingInfo.state} onChange={handleChange} placeholder="State" style={styles.input} required />
// //                             <input type="text" name="zipCode" value={shippingInfo.zipCode} onChange={handleChange} placeholder="ZIP Code" style={styles.input} required />
// //                             <input type="tel" name="phone" value={shippingInfo.phone} onChange={handleChange} placeholder="Phone Number" style={styles.input} required />
